  ...
  return (
    <div className="my-12 md:my-36">
      <Container>
        ...
        {/* ------------------card Items------------------- */}
        <div className="reveal w-full snap-x snap-mandatory overflow-x-auto">
          <div className="mt-12 grid w-[950px] grid-cols-3 gap-8 md:w-full ">
            <div className="bg-teal min-h-[500px] snap-center space-y-8 px-8 py-16 ">
              ...
              <ButtonInfo className="flex hover:bg-white hover:text-primaryDark group text-white btn-rounded-full-border space-x-2">
